...
class JayjeetExperiment(ExperimentInterface):
    ...
    def __init__(self):
        super(JayjeetExperiment, self).__init__()
    ...
    def get_executions(self):
        ...
        for x in data_multipliers:
            ...
            configbuilder.set('mode', '--spark-only')
            ...
            configbuilder.set('resultdir', '~/results/jayjeet_experiment')
            configbuilder.set('ceph_force_reinstall', True)
            configbuilder.set('ceph_arrow_url', 'https://github.com/uccross/skyhookdm-arrow/archive/refs/heads/fix-memleak-in-cls.zip')
